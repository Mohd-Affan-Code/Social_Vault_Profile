...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <button className="fixed bottom-6 right-6 w-14 h-14 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-full shadow-xl hover:shadow-2xl transition-all duration-200 flex items-center justify-center sm:hidden hover:scale-110 active:scale-95">
